...
import { HeadHelper } from "./HeadHelper";
...
const Profile = ({ isFollowing, setIsFollowing }: ProfileProps ) => {
    ...
    return (
        <>
    <HeadHelper title={`A9Blogs - profile - ${author.username}`} desc="home page of a9blogs"/>
            ...
            <div className="pr-4">
                ...
                <div className="flex items-center justify-start space-x-4">
                    ...
                    <div className="">
                        ...
                        <Link href={`/profile/followers/${author._id}`} className="text-lg text-gray-600 hover:text-gray-800">{followersCount} Followers</Link>
                    </div>
                </div>
                ...
                {id === currentUserId && (
                    <div className="mt-4">
                        <button onClick={() => router.push('/reset-password')} className="w-full py-1.5 px-4 bg-blue-500/95 text-white rounded-xs">Reset Password</button>
                    </div>
                )}
            ...
            {followingList?.length > 0 ? (
                <div className="pr-4">
                    ...
                    <div className="flex justify-end mt-6">
                        <Link href={`/profile/followings/${author._id}`} className="text-lg text-gray-600 hover:text-gray-800">see all ({followingList.length})</Link>
                    </div>

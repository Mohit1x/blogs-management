          ...
          <div className="flex items-center justify-center space-x-10">
            <button
              ...
              className={`${
                pathname === "/"
                  ? "text-black text-xl"
                  : "text-gray-500 text-xl hover:text-black"
              }`}
            >
              Home
            </button>
              ...
              <button
                ...
                className={`${
                  pathname === "/add-blog"
                    ...
                    : "flex items-center space-x-2 text-gray-500 hover:text-black"
                }`}
              >
            ...
            <div
              className={`${
                query ? "border-2 border-black" : "border-2 border-transparent"
              }   relative flex items-center bg-gray-100 pl-4 rounded-full`}
            >
                ...
                <div className="absolute left-0 top-14 min-w-[380px] min-h-fit bg-white rounded-xs shadow-lg border max-h-60 overflow-y-auto">
                  <div className="p-2.5">
                    ...
                    {results.slice(0, 5).map((blog: any) => (
                      <a
                        target="_blank"
                        href={`http://localhost:5000/blogs/${blog._id}.html`}
                      >
                        <div
                          key={blog._id}
            ...
            {isLoggedIn ? (
              ...
              >
                <button onClick={() => setPopoverVisible(!isPopoverVisible)}>
                  <img
                    src={profileImage !== "" ? profileImage : "/avatar.jpg"}
                    alt="profile"
                ...
                {isPopoverVisible && (
                  <div className="absolute min-w-80 -left-64 top-14 bg-white shadow px-4">
                    <a
                      ...
                      className="w-full flex items-center justify-start px-4 space-x-3 text-gray-500 hover:text-gray-900"
                    >
                    ...
                    <button
                      ...
                      className="flex flex-col items-start py-4 px-4 group w-full cursor-pointer"
                    >
